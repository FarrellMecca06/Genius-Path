...
<main class="page narrow">
    ...
    <?php if ($result):
        ...
        <article class="card card-career"
            style="border: 2px solid #2545f5; padding: 2rem; border-radius: 12px; background: #fff; position: relative; box-shadow: 0 10px 15px -3px rgba(0, 0, 0, 0.1);">
            <div class="card-badge"
                style="background: #2545f5; color: white; padding: 4px 12px; border-radius: 9999px; font-size: 0.8rem; position: absolute; top: 20px; right: 20px;">
                <?php echo htmlspecialchars($result['career_cat']); ?>
            </div>

            <h2 style="margin-top: 1rem; color: #1e293b; font-size: 1.8rem;">
                <?php echo htmlspecialchars($result['career_name']); ?>
            </h2>
            ...
            <div
                style="background: #f8fafc; padding: 1.5rem; border-radius: 8px; margin: 1.5rem 0; border-left: 4px solid #2545f5;">
            ...
            <div
                style="display: flex; flex-direction: column; gap: 0.75rem; font-size: 0.95rem; border-top: 1px solid #e2e8f0; padding-top: 1rem; color: #1e293b;">
            ...
            <div style="margin-top: 2rem; text-align: center; border-top: 1px solid #f1f5f9; padding-top: 2rem;">
                <img src="<?php echo $imageURL; ?>" alt="Roadmap"
    ...
    <?php else: ?>
        <div class="alert-error" style="text-align: center; padding: 3rem;">
            <p>Recommendation data not found. Please do the assessment</p>
        </div>
    <?php endif; ?>
</main>
