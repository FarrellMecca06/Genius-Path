    ...
    <form method="POST" action="admin_careers.php">
        ...
        <div class="form-field full">
            ...
            <textarea name="description"
                rows="2"><?php echo htmlspecialchars($editCareer['description'] ?? ''); ?></textarea>
        </div>

        <div class="form-field full">
            <label>Required skills</label>
            <textarea name="required_skills"
                rows="2"><?php echo htmlspecialchars($editCareer['required_skills'] ?? ''); ?></textarea>
        </div>
        ...
        <div class="form-grid">
            ...
            <div class="form-field">
                ...
                <input type="text" name="outlook" value="<?php echo htmlspecialchars($editCareer['outlook'] ?? ''); ?>">
            </div>
        </div>
                ...
                <?php foreach ($careers as $c): ?>
                    <tr style="border-bottom:1px solid #e5e7eb;">
                        ...
                        <td style="padding:0.4rem;">
                            <a href="admin_careers.php?edit=<?php echo (int) $c['id']; ?>" class="btn-card"
                                style="font-size:0.75rem;">Edit</a>
                            <a href="admin_careers.php?delete=<?php echo (int) $c['id']; ?>" class="btn-card"
                                style="font-size:0.75rem;margin-left:0.25rem;">Delete</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
